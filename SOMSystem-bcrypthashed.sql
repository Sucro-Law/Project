DROP DATABASE IF EXISTS somsystem;
CREATE DATABASE somsystem;
USE somsystem;
...
INSERT INTO `somsystem`.`users` (`school_id`, `full_name`, `email`, `password`, `account_type`) VALUES ('SN-00000123', 'Kelia Gamayo', 'kagamayow@gmail.com', '$2y$12$/7S4FPsschkWOobdKjKdIODYED8JogholKsJ9MvTFdXl1rFXwIILe', 'Student');
INSERT INTO `somsystem`.`users` (`school_id`, `full_name`, `email`, `password`, `account_type`) VALUES ('FN-00001010', 'Josef Velayo', 'jkvelayo@gmail.com', '$2y$12$l61GS4/R82DWH1SERzMPyOBzWhnTSVeCx1YIP7rVBz25/.FT4VUtK', 'Faculty');
INSERT INTO `somsystem`.`users` (`school_id`, `full_name`, `email`, `password`, `account_type`) VALUES ('FN-00022121', 'Franzel Cayona', 'cfcayona@gmail.com', '$2y$12$2bQDGxKMdKLRkYJ.jiZ9d.QKN6B4e.mj7xG6v1eOpxRKGIm7XiAwi', 'Faculty');
INSERT INTO `somsystem`.`users` (`school_id`, `full_name`, `email`, `password`, `account_type`) VALUES ('SN-00000101', 'Evans Gutierrez', 'evansg@gmail.com', '$2y$12$xKvuaX8OL/NJKbBn.AvqIesKFe9ptZBitMpwD7u02EyTqRbJs7pIW', 'Student');
INSERT INTO `somsystem`.`users` (`school_id`, `full_name`, `email`, `password`, `account_type`) VALUES ('SN-00001110', 'Siska Ramirez', 'sisramiez@gmail.com', '$2y$12$iySQTN.S3DOGi/ANOQCOeO/FVBgyCGuYlm0Wxlh8Dux.xb6fWf3TO', 'Student');
INSERT INTO `somsystem`.`users` (`school_id`, `full_name`, `email`, `password`, `account_type`) VALUES ('FN-00022322', 'Ken Mondragon', 'kennyken@gmail.com', '$2y$12$vIK2JPamyFIoxV3ZymEVzecFDmlfn6A9jB/WU5Cj3g58Znp.dW2HK', 'Faculty');

INSERT INTO `somsystem`.`organizations` (`org_name`, `description`, `status`, `created_at`) VALUES ('AWS PUP', 'CCIS Students are welcome', 'Active', '2020-01-20');
INSERT INTO `somsystem`.`organizations` (`org_name`, `description`, `status`, `created_at`) VALUES ('GDG PUP', 'CCIS Students are welcome', 'Active', '2021-05-12');
INSERT INTO `somsystem`.`organizations` (`org_name`, `description`, `status`, `created_at`) VALUES ('Sintang Pusa', 'PUP Organization for cats', 'Active', '2015-02-14');
...
INSERT INTO `somsystem`.`org_officers` (`membership_id`, `org_id`, `position`, `term_start`, `term_end`) VALUES ('MEM-00000003', 'ORG-00000003', 'President', '2026-01-05', '2027-01-05');
